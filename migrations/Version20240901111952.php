 ...
 */
final class Version20240901111952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action (id INT AUTO_INCREMENT NOT NULL, module_id INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, agent_comment LONGTEXT DEFAULT NULL, agent_validated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', agent_visa VARCHAR(255) DEFAULT NULL, mentor_comment LONGTEXT DEFAULT NULL, mentor_validated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', mentor_visa VARCHAR(255) DEFAULT NULL, INDEX IDX_47CC8C92AFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE logbook (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_logbook (user_id INT NOT NULL, logbook_id INT NOT NULL, INDEX IDX_B1668D1AA76ED395 (user_id), INDEX IDX_B1668D1AFA6B07A0 (logbook_id), PRIMARY KEY(user_id, logbook_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_logbook ADD CONSTRAINT FK_B1668D1AA76ED395 FOREIGN KEY (user_id) REFERENCES `users` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_logbook ADD CONSTRAINT FK_B1668D1AFA6B07A0 FOREIGN KEY (logbook_id) REFERENCES logbook (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_logbook DROP FOREIGN KEY FK_B1668D1AA76ED395');
        $this->addSql('ALTER TABLE user_logbook DROP FOREIGN KEY FK_B1668D1AFA6B07A0');
