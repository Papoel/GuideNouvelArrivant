 ...
 */
final class Version20240921213511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action (id INT AUTO_INCREMENT NOT NULL, module_id INT DEFAULT NULL, user_id INT NOT NULL, logbook_id INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, agent_comment LONGTEXT DEFAULT NULL, agent_validated_at DATETIME DEFAULT NULL, agent_visa VARCHAR(255) DEFAULT NULL, mentor_comment LONGTEXT DEFAULT NULL, mentor_validated_at DATETIME DEFAULT NULL, mentor_commented_at DATETIME DEFAULT NULL, mentor_visa VARCHAR(255) DEFAULT NULL, INDEX IDX_47CC8C92AFC2B591 (module_id), INDEX IDX_47CC8C92A76ED395 (user_id), INDEX IDX_47CC8C92FA6B07A0 (logbook_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE action ADD CONSTRAINT FK_47CC8C92FA6B07A0 FOREIGN KEY (logbook_id) REFERENCES logbook (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action DROP FOREIGN KEY FK_47CC8C92FA6B07A0');
