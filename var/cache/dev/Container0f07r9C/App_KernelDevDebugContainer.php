...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Flasher\Symfony\Profiler\FlasherDataCollector(($container->privates['flasher.notification_logger_listener'] ??= new \Flasher\Prime\EventDispatcher\EventListener\NotificationLoggerListener()), $container->parameters['flasher']));
        $instance->add($g);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xNgdfpwWH4', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aKLayD09Fo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('f6b1bTkycv', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7dLHVUPp1X', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f2histXNLp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('73+sFxI3UC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dAk31e+crp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getFlasherService($container)
    {
        ...
        $b = ($container->privates['flasher.storage_manager'] ?? self::getFlasher_StorageManagerService($container));
        ...
        ])), new \Flasher\Prime\Response\ResponseManager(new \Flasher\Prime\Response\Resource\ResourceManager(new \Flasher\Symfony\Template\TwigTemplateEngine($a), ($container->privates['flasher.asset_manager'] ??= new \Flasher\Prime\Asset\AssetManager((\dirname(__DIR__, 4).'/public'), (\dirname(__DIR__, 4).'/public/vendor/flasher/manifest.json'))), '/vendor/flasher/flasher.min.js', $container->parameters['flasher.resources']), $b, ($container->privates['flasher.event_dispatcher'] ?? self::getFlasher_EventDispatcherService($container))), $b);
    ...
    {
        return $container->privates['.ux_icons.cache'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WBNNJ9FRLX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['.ux_icons.twig_icon_runtime'] = new \Symfony\UX\Icons\Twig\UXIconRuntime(new \Symfony\UX\Icons\IconRenderer(($container->privates['.ux_icons.cache_icon_registry'] ?? self::get_UxIcons_CacheIconRegistryService($container)), ['fill' => 'currentColor', 'height' => '1em', 'width' => '1em'], [], []), false, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
    ...
    protected static function getAdminUrlGeneratorService($container)
    {
        $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function ($container) {
            ...
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($container->targetDir.'', ['App\\Controller\\Admin\\DashboardController' => '511d62d'], ['511d62d' => 'App\\Controller\\Admin\\DashboardController'])), $b, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)));
        };
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JdBkahwmMv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WLa-0nC-mp', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gf6N7ASnlN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('S24MDjzu4K', 0, (\dirname(__DIR__, 3).'/share/dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P6Ym7tWDfj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3UzDudwFkE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m7BPOdSKEe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BeBHzI7Pk1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eOTN3VFnFz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getFlasher_EventDispatcherService($container)
    {
        ...
        $instance->addListener(new \Flasher\Prime\EventDispatcher\EventListener\TranslationListener(new \Flasher\Symfony\Translation\Translator(($container->services['translator'] ?? self::getTranslatorService($container)))));
        $instance->addListener(new \Flasher\Prime\EventDispatcher\EventListener\ApplyPresetListener($container->parameters['flasher.presets']));
    ...
    {
        return $container->privates['flasher.flasher_listener'] = new \Flasher\Symfony\EventListener\FlasherListener(new \Flasher\Prime\Http\ResponseExtension(($container->services['flasher'] ?? self::getFlasherService($container)), new \Flasher\Prime\Http\Csp\ContentSecurityPolicyHandler(new \Flasher\Prime\Http\Csp\NonceGenerator()), $container->parameters['flasher.excluded_paths']));
    }
    ...
    {
        return $container->privates['flasher.storage_manager'] = new \Flasher\Prime\Storage\StorageManager(new \Flasher\Prime\Storage\Storage(new \Flasher\Symfony\Storage\SessionBag(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()))), ($container->privates['flasher.event_dispatcher'] ?? self::getFlasher_EventDispatcherService($container)), new \Flasher\Prime\Storage\Filter\FilterFactory(), []);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\AccountDeletionExtension(($container->privates['App\\Services\\RGPD\\AccountDeletionService'] ?? self::getAccountDeletionServiceService($container)), ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container))));
        $instance->addExtension(new \App\Twig\AppExtension());
        $instance->addExtension(new \App\Twig\LogbookExtension(($container->privates['App\\Services\\Logbook\\LogbookThemeService'] ?? self::getLogbookThemeServiceService($container))));
        $instance->addExtension(new \App\Twig\LogbooksProgressExtension(($container->privates['App\\Services\\Logbook\\LogbookProgressService'] ??= new \App\Services\Logbook\LogbookProgressService())));
        $instance->addExtension(new \App\Twig\RoleExtension());
        ...
        $instance->addExtension(new \Flasher\Symfony\Twig\FlasherTwigExtension(($container->services['flasher'] ?? self::getFlasherService($container))));
