...
class getSecurity_Listener_Main_UserProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Http\EventListener\UserProviderListener($a);

        if (isset($container->privates['security.listener.main.user_provider'])) {
            return $container->privates['security.listener.main.user_provider'];
        }

        return $container->privates['security.listener.main.user_provider'] = $instance;
    }
}
