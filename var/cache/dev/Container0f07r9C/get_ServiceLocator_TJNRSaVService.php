...
class get_ServiceLocator_TJNRSaVService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.TJNRSaV'])) {
            return $container->privates['.service_locator.TJNRSaV'];
        }

        return $container->privates['.service_locator.TJNRSaV'] = $instance;
    }
}
