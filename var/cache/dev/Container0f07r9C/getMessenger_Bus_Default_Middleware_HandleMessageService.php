...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Message\\SendReminderEmails' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.fF7NbCi'] ?? $container->load('get_Messenger_HandlerDescriptor_FF7NbCiService'));
        }, 1), 'App\\Message\\WeeklyReminderEmailMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.ZylQEtg'] ?? $container->load('get_Messenger_HandlerDescriptor_ZylQEtgService'));
