...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Command\\CheckMigrationCommand' => ['privates', '.App\\Command\\CheckMigrationCommand.lazy', 'getCheckMigrationCommand_LazyService', true],
            'App\\Command\\Cron\\CronCheckCommand' => ['privates', '.App\\Command\\Cron\\CronCheckCommand.lazy', 'getCronCheckCommand_LazyService', true],
            'App\\Command\\ImportUsersCommand' => ['privates', '.App\\Command\\ImportUsersCommand.lazy', 'getImportUsersCommand_LazyService', true],
            'App\\Command\\ProcessDeletionRequestsCommand' => ['privates', '.App\\Command\\ProcessDeletionRequestsCommand.lazy', 'getProcessDeletionRequestsCommand_LazyService', true],
            'App\\Command\\PushFixturesCommand' => ['privates', '.App\\Command\\PushFixturesCommand.lazy', 'getPushFixturesCommand_LazyService', true],
            'App\\Command\\ResetMigrationVersionsCommand' => ['privates', '.App\\Command\\ResetMigrationVersionsCommand.lazy', 'getResetMigrationVersionsCommand_LazyService', true],
            'App\\Command\\Scheduler\\SendEmailReminderCommand' => ['privates', '.App\\Command\\Scheduler\\SendEmailReminderCommand.lazy', 'getSendEmailReminderCommand_LazyService', true],
            'App\\Command\\Scheduler\\SendMailCommand' => ['privates', '.App\\Command\\Scheduler\\SendMailCommand.lazy', 'getSendMailCommand_LazyService', true],
            'App\\Command\\helper\\RestoreDataCommand' => ['privates', '.App\\Command\\helper\\RestoreDataCommand.lazy', 'getRestoreDataCommand_LazyService', true],
