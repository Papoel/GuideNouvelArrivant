...
class __TwigTemplate_7d4cf10f0d50808a70f9ab3ce1523350 extends Template
{
...
(isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 6, $this->source); })()), "svgContents", [], "any", false, false, false, 6)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
    ...
    ";
            ...
            // line 10
            yield "            ";
            yield $this->env->getRuntime('Symfony\UX\Icons\Twig\UXIconRuntime')->renderIcon(CoreExtension::getAttribute($this->env, $this->source, (isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 10, $this->source); })()), "name", [], "any", false, false, false, 10), CoreExtension::getAttribute($this->env, $this->source, (isset($context["attributes"]) || array_key_exists("attributes", $context) ? $context["attributes"] : (function () { throw new RuntimeError('Variable "attributes" does not exist.', 10, $this->source); })()), "all", [], "any", false, false, false, 10));
            yield "
        ";
            // line 12
            yield "    ";
...
";
    ...
    {
        return array (  81 => 13,  78 => 12,  73 => 10,  71 => 9,  65 => 7,  63 => 6,  58 => 5,  55 => 4,  53 => 3,  48 => 2,);
    }
...
", "@EasyAdmin/components/Icon.html.twig", "/Users/papoel/Documents/sandbox/side_project/GuideNouvelArrivant/vendor/easycorp/easyadmin-bundle/templates/components/Icon.html.twig");
    }
}
