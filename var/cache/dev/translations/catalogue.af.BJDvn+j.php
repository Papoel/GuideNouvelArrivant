...
$catalogueFr = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'Payment Required' => 'Paiement requis pour accéder à la ressource.',
    'Forbidden' => 'Accès interdit.',
    'Not Found' => 'Ressource non trouvée.',
    'Method Not Allowed' => 'Méthode de requête non autorisée.',
    'Not Acceptable' => 'La ressource demandée n\'est pas disponible dans un format qui respecterait les en-têtes « Accept
                    » de la requête.
                ',
    'Proxy Authentication Required' => 'Accès à la ressource autorisé par identification avec le proxy.',
    'Request Time-out' => 'Temps d’attente d’une requête du client, écoulé côté serveur.',
    'Conflict' => 'La requête ne peut être traitée à la suite d\'un conflit avec l\'état actuel du serveur.',
    'Gone' => 'La ressource n\'est plus disponible et aucune adresse de redirection n’est connue.',
    'Length Required' => 'La longueur de la requête n’a pas été précisée.',
    'Precondition Failed' => 'Préconditions envoyées par la requête non vérifiées.',
    'Request Entity Too Large' => 'Traitement abandonné dû à une requête trop importante.',
    'Request-URI Too Long' => 'URI trop longue.',
    'Unsupported Media Type' => 'Format de requête non supporté pour une méthode et une ressource données.',
    'Requested range unsatisfiable' => 'Champs d’en-tête de requête « range » incorrect.',
    'Expectation failed' => 'Comportement attendu et défini dans l’en-tête de la requête insatisfaisante.',
    'I’m a teapot' => '« Je suis une théière » : Ce code est défini dans la RFC 2324 datée du 1er avril 1998, Hyper
                    Text Coffee Pot Control Protocol.
                ',
    'Page expired' => 'Ressource expirée.',
    'Bad mapping / Misdirected Request' => 'La requête a été envoyée à un serveur qui n\'est pas capable de produire une réponse.',
    'Unprocessable Content' => 'La requête est bien formée mais a été incapable d\'être suivie en raison d\'erreurs sémantiques.',
    'Locked' => 'L’opération ne peut avoir lieu car la ressource est verrouillée.',
    'Method failure' => 'Une méthode de la transaction a échoué.',
    'Too Early' => 'Le serveur ne peut traiter la demande car elle risque d\'être rejouée.',
    'Upgrade Required' => 'Le client devrait changer de protocole, par exemple au profit de TLS/1.0.',
    'Invalid digital signature' => 'La signature numérique du document est non-valide.',
    'Precondition Required' => 'La requête doit être conditionnelle.',
    'Too Many Requests' => 'Le client a émis trop de requêtes dans un délai donné.',
    'Request Header Fields Too Large' => 'Les entêtes HTTP émises dépassent la taille maximale admise par le serveur.',
    'No Response' => 'Indique que le serveur n\'a retourné aucune information vers le client et a fermé la connexion.
                ',
    'Retry With' => 'La requête devrait être renvoyée après avoir effectué une action.',
    'Blocked by Windows Parental Controls' => 'Cette erreur est produite lorsque les outils de contrôle parental de Microsoft Windows sont
                    activés et bloquent l’accès à la page.
                ',
    'Unavailable For Legal Reasons' => 'La ressource demandée est inaccessible pour des raisons d\'ordre légal.',
    'Unrecoverable Error' => 'Erreur irrécupérable.',
    'SSL Certificate Error' => 'Une extension de l\'erreur 400 Bad Request, utilisée lorsque le client a fourni un certificat
                    invalide.
                ',
    'SSL Certificate Required' => 'Une extension de l\'erreur 400 Bad Request, utilisée lorsqu\'un certificat client requis n\'est pas
                    fourni.
                ',
    'HTTP Request Sent to HTTPS Port' => 'Une extension de l\'erreur 400 Bad Request, utilisée lorsque le client envoie une requête HTTP
                    vers le port 443 normalement destiné aux requêtes HTTPS.
                ',
    'Token expired/invalid' => 'Le jeton a expiré ou est invalide.',
    'Client Closed Request' => 'Le client a fermé la connexion avant de recevoir la réponse.',
    'Internal Server Error' => 'Erreur interne du serveur.',
    'Not Implemented' => 'Fonctionnalité réclamée non supportée par le serveur.',
    'Bad Gateway ou Proxy Error' => 'En agissant en tant que serveur proxy ou passerelle, le serveur a reçu une réponse invalide
    ...
    'HTTP Version not supported' => 'Version HTTP non gérée par le serveur.',
    'Variant Also Negotiates' => 'Erreur de négociation. Transparent content negociation.',
    'Insufficient storage' => 'Espace insuffisant pour modifier les propriétés ou construire la collection.',
    'Loop detected' => 'Boucle dans une mise en relation de ressources.',
    'Bandwidth Limit Exceeded' => 'Utilisé par de nombreux serveurs pour indiquer un dépassement de quota.',
    'Not extended' => 'La requête ne respecte pas la politique d\'accès aux ressources HTTP étendues.',
    'Network Authentication Required' => 'Le client doit s\'authentifier pour accéder au réseau.',
    'Unknown Error' => 'Réponse générique lorsque le serveur d\'origine retourne un résultat imprévu.',
    'Web Server Is Down' => 'Le serveur a refusé la connexion depuis Cloudflare.',
    'Connection Timed Out' => 'Cloudflare n\'a pas eu de retour avec le serveur d\'origine dans les temps.',
    'Origin Is Unreachable' => 'Cloudflare n\'a pas réussi à joindre le serveur d\'origine.',
    'A Timeout Occurred' => 'Cloudflare a établi une connexion TCP avec le serveur d\'origine mais n\'a pas reçu de réponse
                    HTTP avant l\'expiration du délai de connexion.
                ',
    'SSL Handshake Failed' => 'Cloudflare n\'a pas pu négocier un SSL/TLS handshake avec le serveur d\'origine.',
    'Invalid SSL Certificate' => 'Cloudflare n\'a pas pu valider le certificat SSL présenté par le serveur d\'origine.',
    'Railgun Error' => 'La requête a dépassé le délai de connexion ou a échoué après que la connexion WAN a été
                    établie.
                ',
  ),
));
