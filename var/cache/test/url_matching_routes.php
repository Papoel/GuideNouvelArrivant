                        ...
                        .'|mentor/([^/]++)(?'
                            ...
                            .'|/padawan/([^/]++)/carnet/([^/]++)(?'
                                ...
                                .'|/module/([^/]++)/action/([^/]++)/(?'
                                    ...
                                    .'|validate(*:1169)'
                                    .'|invalidate(*:1188)'
                                    .'|delete\\-mentor\\-comment(*:1220)'
                                .')'
                            .')'
                        .')'
                    .')'
                .')'
                .'|/reset\\-password/reset(?:/([^/]++))?(*:1270)'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        765 => [[['_route' => 'ux_live_component', '_live_action' => 'get'], ['_live_component', '_live_action'], null, null, false, true, null]],
        802 => [[['_route' => 'app_account_deletion_cancel_by_token', '_controller' => 'App\\Controller\\App\\AccountDeletionPublicController::cancelByToken'], ['token'], ['GET' => 0], null, false, true, null]],
        879 => [[['_route' => 'action_edit', '_controller' => 'App\\Controller\\App\\Dashboard\\ActionController::edit'], ['nni', 'moduleId', 'logbookId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        900 => [[['_route' => 'action_clear', '_controller' => 'App\\Controller\\App\\Dashboard\\ActionController::clearComment'], ['nni', 'id'], ['GET' => 0], null, false, false, null]],
        909 => [[['_route' => 'action_delete', '_controller' => 'App\\Controller\\App\\Dashboard\\ActionController::delete'], ['nni', 'id'], ['POST' => 0], null, false, true, null]],
        946 => [[['_route' => 'my_feedbacks_index', '_controller' => 'App\\Controller\\App\\Dashboard\\FeedbackController::index'], ['nni'], ['GET' => 0], null, false, false, null]],
        963 => [[['_route' => 'my_feedbacks_detail', '_controller' => 'App\\Controller\\App\\Dashboard\\FeedbackController::detail'], ['nni', 'id'], ['GET' => 0], null, false, true, null]],
        975 => [[['_route' => 'my_feedbacks_new', '_controller' => 'App\\Controller\\App\\Dashboard\\FeedbackController::new'], ['nni'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        987 => [[['_route' => 'my_feedbacks_list', '_controller' => 'App\\Controller\\App\\Dashboard\\FeedbackController::list'], ['nni'], ['GET' => 0], null, false, false, null]],
        1010 => [[['_route' => 'my_feedbacks_review', '_controller' => 'App\\Controller\\App\\Dashboard\\FeedbackController::review'], ['nni', 'id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1021 => [[['_route' => 'dashboard_index', '_controller' => 'App\\Controller\\App\\Dashboard\\DashboardController::index'], ['nni'], ['GET' => 0, 'POST' => 1], null, true, true, null]],
        1049 => [[['_route' => 'mentor_dashboard_index', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorDashboardController::index'], ['nni'], ['GET' => 0], null, true, true, null]],
        1094 => [[['_route' => 'mentor_logbook_details', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorLogbookController::details'], ['nni', 'padawanNni', 'id'], ['GET' => 0], null, false, true, null]],
        1152 => [[['_route' => 'mentor_logbook_action_edit', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorLogbookController::edit'], ['nni', 'padawanNni', 'logbookId', 'moduleId', 'actionId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1169 => [[['_route' => 'mentor_logbook_action_validate', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorLogbookController::validate'], ['nni', 'padawanNni', 'logbookId', 'moduleId', 'actionId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1188 => [[['_route' => 'mentor_logbook_action_invalidate', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorLogbookController::invalidate'], ['nni', 'padawanNni', 'logbookId', 'moduleId', 'actionId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1220 => [[['_route' => 'mentor_logbook_action_delete_comment', '_controller' => 'App\\Controller\\App\\Dashboard\\Mentor\\MentorLogbookController::deleteComment'], ['nni', 'padawanNni', 'logbookId', 'moduleId', 'actionId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1270 => [
