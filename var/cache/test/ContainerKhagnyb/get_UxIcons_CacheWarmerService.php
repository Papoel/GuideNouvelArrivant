 ...
 */
class get_UxIcons_CacheWarmerService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\Icons\IconCacheWarmer(($container->privates['.ux_icons.cache_icon_registry'] ?? self::get_UxIcons_CacheIconRegistryService($container)), $a);
