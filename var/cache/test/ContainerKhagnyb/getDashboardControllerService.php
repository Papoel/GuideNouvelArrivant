...
class getDashboardControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \App\Controller\Admin\DashboardController((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), ($container->privates['App\\Repository\\LogbookRepository'] ?? self::getLogbookRepositoryService($container)), ($container->privates['App\\Repository\\ThemeRepository'] ?? $container->load('getThemeRepositoryService')), ($container->privates['App\\Repository\\ModuleRepository'] ?? self::getModuleRepositoryService($container)), ($container->privates['App\\Repository\\ServiceRepository'] ?? $container->load('getServiceRepositoryService')), ($container->privates['App\\Repository\\LogbookTemplateRepository'] ?? $container->load('getLogbookTemplateRepositoryService')), ($container->privates['App\\Repository\\JobRepository'] ?? $container->load('getJobRepositoryService')), ($container->privates['App\\Repository\\SpecialityRepository'] ?? $container->load('getSpecialityRepositoryService')));
