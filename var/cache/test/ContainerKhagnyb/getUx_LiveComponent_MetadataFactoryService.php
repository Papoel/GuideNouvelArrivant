 ...
 */
class getUx_LiveComponent_MetadataFactoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\LiveComponent\Metadata\LiveComponentMetadataFactory($a, ($container->privates['property_info'] ?? self::getPropertyInfoService($container)), ($container->privates['type_info.resolver'] ?? $container->load('getTypeInfo_ResolverService')));
